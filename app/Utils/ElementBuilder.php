...
class ElementBuilder
{
    ...
    public static function buildPost(
        ...
        $post_element .= "<p class='my-2'>$overview</p><i>Dernière mise à jour le $date</i></div>";
    ...
    public static function buildComment(
        ...
        $comment_element .= "<i> le $post_date</i></div>";
        ...
        $comment_element .= "<i class='text-secondary'>Dernière modification le: $last_update</i></li>";
     ...
     * @return string
     */
    public static function buildAdminComment(string $path, string $username, string $user_id, string $content, string $post_date, string $last_update, int $comment_id): string 
    {
        ...
        $comment_element .= "<i class='text-secondary'> le $post_date</i>";
        $comment_element .= "<p class='my-3 text-break'>$content</p>";
        $comment_element .= "</div></div>";
        $comment_element .= "<i class='text-secondary'>Dernière modification le: $last_update</i></div></th>";
    ...
    {
        $toast_element  = "<div class='rounded-pill bg-primary tag text-light py-2 px-3 my-1 mx-1 d-flex align-items-center'>";
